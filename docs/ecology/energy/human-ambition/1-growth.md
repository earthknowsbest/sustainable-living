...
Con người ngoài việc sở hữu những điểm mạnh ấn tượng, cũng có những điểm yếu chí mạng. Một trong số đó có lẽ là sự thấu hiểu về những hệ quả toán học của cái gọi là tăng trưởng theo cấp số nhân (exponential growth). Trớ trêu thay, những mục tiêu kinh tế chính trị của chúng ta thường hướng đến việc hỗ trợ tăng trưởng kinh tế. Do sự kì vọng và ham muốn tăng tưởng không ngừng đã ngấm sâu vào xã hội, việc khảo sát kĩ lưỡng về hiện tượng này là một điều quan trọng, nhằm tránh cho chúng ta những hiểu biết căn bản sai lầm. Trong chương này, chúng ta cùng tìm hiểu bản chất chung của tăng trưởng theo cấp số nhân, để hiểu rõ tính bất khả thi của việc tiếp diễn nó trong dài hạn bằng cách làm sáng tỏ những hệ quả vô lí khi sự tăng trưởng này kéo dài mãi mãi. Kết quả cho thấy kết cấu xã hội của chúng ta (dựa trên tăng trưởng) cuối cùng cũng phải đối mặt với sự chuyển hướng bắt buộc từ mô hình hiện tại - đây là kiến thức mỗi người cần ghi nhớ. Những chương sau sẽ tập trung vào những ứng dụng cho kinh tế và tăng tưởng dân số - bao gồm những đường hàm tăng trưởng logistic, sau đó nhấn mạnh đến những giới hạn (limits) mà hành tinh hữu hạn (finite planet) của chúng ta đòi hỏi.

## 1.1 Vi khuẩn trong hũ

Một trong những đặc điểm quan trọng của tăng trương theo hàm số mũ đó là thời gian cần thiết để nhân đôi (doubling time) là một hằng số (constant). Một khái niệm quan trọng và thuận tiện chúng ta sẽ sử dùng thường xuyên trong chương này là qui luật 70: 

Định nghĩa 1.1.1 Qui luật 70: Thời gian cần thiết để nhân đôi được liên hệ với tỉ lệ phần trăm tăng trưởng bằng công thức lấy 70 chia cho tỉ lệ phần trăm ấy. Ví dụ, 1% tăng tưởng sẽ nhân đôi giá trị thực qua 70 năm, trong khi với tỉ lệ 2%, thời gian ấy à 35 năm, và với 10% là 7 năm. Điều này cũng đúng với những khung thời gian khác: nếu những ca nhiễm bệnh trong một đại dịch tăng trưởng với mức độ 3,5% một ngày, những ca bệnh sẽ gấp đôi trong vòng 20 ngày.

Chúng ta sẽ thấy qui luật 70 xuất hiện trong toán học như thế nào vào cuối chương này. Nhưng trước tiên, việc thấu hiểu về hệ quả (consequences) của nó thực ra quan trọng hơn. Để giản tiện, lấy ví dụ một thị trấn gấp đôi dân số của mình mỗi 10 năm (hay theo qui luật 70, chúng ta có tỉ lệ tăng dân số là 7%/năm). Bắt đầu vào năm 1900 với 100 cư dân, chúng ta kì vọng dân số sẽ là 200 người vào năm 1910, 400 người vào năm 1920, 800 người vào năm 1930, và sau đó đạt đến 100.000 người vào năm 2000 (xem bảng 1.1). Nếu giữ nguyên tỉ lệ tăng trưởng này, dân số thị trấn sẽ bằng với dân số thế giới chỉ sau 260 năm từ khi bắt đầu theo ví dụ trên.

Nhưng hãy cùng khám phá một ví dụ làm nổi bật trực giác sai lầm của chúng ta đối với tăng trưởng theo cấp số nhân. Ở đây, chúng ta có một hũ rất nhiều dinh dưỡng, được cho thêm vi khuẩn với số lượng chính xác sao cho mỗi lần vi khuẩn nhân đôi diễn ra sau 10 phút, và hũ này sẽ chứa đầy vi khuẩn sau đúng 24 giờ. Thí nghiệm này bắt đầu từ đúng nửa đêm. Câu hỏi: vào lúc nào thì hũ này sẽ đầy một nửa?

Hãy dành khoảng một phút suy nghĩ. Trực giác thông thường mách bảo: hũ này sẽ đầy một nửa vào giữa trưa hôm sau - bằng một nửa tổng thời gian thí nghiệm. Nhưng sẽ thế nào khi chúng ta giải quyết bài toán ngược lại từ lúc đầy? Hũ sẽ đầu vào nửa đêm hôm sau, và thời gian nhân đôi là 10 phút. Vậy khi nào hũ sẽ đầy một nửa?

Câu trả lời: chúng ta chỉ cần bớt đi một lần thời gian nhân đôi, hay 11h50p. Hình 1.1. biểu diễn câu chuyện này. Vào lúc 11h đêm, hũ chỉ đầy 1/64 dung tích thực, hay 1,7%. Vậy thì, trong 23h đầu tiên của 24h thí nghiệm, hũ này gần như trống không. Tất cả những hoạt động chỉ diễn ra vào thời điểm cuối, với tốc độ chóng mặt. 

Hình 1.1: 90 phút cuối trong quá trình vi khuẩn (phần màu xanh) phát triển trong hũ, nhân đôi mỗi 10 phút. Gần như chẳng có gì rõ rệt trong 22,5h đầu tiên. Hãy chú ý rằng đường dâng lên của vi khuẩn đã vẽ lên đồ thị của một hàm số mũ.

Giờ hãy cùng tưởng tượng một tình huống khác cũng với hũ vi khuẩn. Thời gian là 11h30 tối hôm sau, hay nửa giờ trước khi kết thúc thí nghiệm. Hũ lúc này đầy 1/8 vi khuẩn. Những người chín chắn trong dự án nuôi cấy vi khuẩn khi dự đoán về tương lai quyết định rằng cần tìm ra nhiều hơn những hũ không chứa đầy dinh dưỡng trong thời gian ngắn để vi khuẩn có thể tiếp tục sinh trưởng với tốc độ cũ. Nhưng hãy thử hình dung vào sự khó tin của nhiều người khác cùng trong dự án: hũ còn lâu mới đầy, và nó vi khuẩn trong đó tăng sinh trưởng qua 141 thế hệ-một khoảng thời gian dài như vô tận. Tuy nhiên, một người trở về thông báo đã tìm ra được hũ đựng dinh dưỡng tương tự. Thật đáng hoan nghênh người hùng đó! Vậy sự sinh trưởng của vi khuẩn sẽ tiếp diễn trong bao lâu? Câu trả lời của bạn như thế nào?

Dân số vi khuẩn sẽ gấp đôi trong 10 phút. Nếu hũ ban đầu đã đầy lúc 12h đêm, dân số đó lại gấp đôi sau 10 phút, lấp đầy chiếc hũ thứ hai lúc 12h10. Lần gấp đôi tiếp theo lấp đầy cả 4 hũ vào lúc 12h20. Sự tưởng thưởng cho người tìm ra hũ mới thật là ngắn ngủi.

Giờ chúng ta có thể hiểu những viễn cảnh tương tự. Một hành tinh đã nuôi dưỡng chúng ta qua không biết bao nhiêu thế hệ, và có vẻ như là vô hạn định, chẳng thể lường hết được, khiến cho viễn cảnh chạm đến một giới hạn nào đó thật khó hình dung. Chúng đã “đầy” một nửa? Hay một phần tư? hay một phần tám? Cả ba lựa chọn này đều đáng sợ, ở mức độ khác nhau. Với tỉ lệ tăng tưởng 2% một năm (tài nguyên sử dụng), thời gian nhân đôi là 35 năm, và chúng ta chỉ có khoảng một thế kỉ, ngay cả khi hiện tại chúng ta chỉ sử dụng 1/8 lượng tài nguyên.

Từ ví dụ vi khuẩn, chúng ta đã khám phá ra nhiều điều. Chúng ta không có thêm hũ nào nữa. Thêm một hành tinh (sao hỏa) có thể ứng với thêm một hũ. Nhưng nó không tương thích với cuộc sống con người, không có thực phẩm, và ở khá xa. Chúng ta cũng chẳng có thêm bất kì một trạm tiếp tế nào. Và ngay cả khi vượt qua những khó khăn thực tế đó, một hành tinh thứ hai sẽ mua được bao nhiều thời gian với việc tăng trưởng không ngừng? 35 năm nữa?

### 1.1.1 Tăng trưởng cấp số nhân theo toán học

Box 1.1: Lời khuyên khi đọc công thức toán
Đây là là một trong những phần chứa nhiều công thức toán phức tạp nhất trong cuốn sách. Nhưng đừng để điều đó gây khó khăn cho bạn, mà cứ từ từ xem xét cẩn thận. Bạn chỉ cần nhận diện tăng trưởng theo cấp số nhân tuân theo một số quy luật không đổi, được trình bày chỉ trong vài trang sách. Đọc đi đọc lại phần này nhiều lần sẽ giúp bạn hiểu được rõ hơn nội dung được trình bày. Những công thức chỉ là những câu ngắn gọn giúp thâu tóm nội dung khái niệm. Nên thay vì chỉ đọc và sử dụng những công thức, tốt hơn bạn cần hiểu ý nghĩa của chúng và lí do tại sao chúng được sử dụng. Theo đó, dù sách được trình bày theo kết cấu cả 2câu văn và công thức đan xen, một tư tưởng xuyên suốt được phát triển qua cả hai thứ ngôn ngữ này. Phần Giới thiệu sẽ làm rõ hơn nội dung trong chương này, và phần Phụ lục A nhắc bạn về toán học căn bản.
