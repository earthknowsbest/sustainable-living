...
> **Hình** $\textbf{3.4}$ *Ước tính dân số toàn cầu trong những thế kỉ gần đây. Trên thang logarit, những đường thẳng theo hệ số góc&mdash;hay độ dốc&mdash;cũng biểu diễn một đường hàm số mũ. Theo đó, bốn phần của hàm số mũ ứng với tỉ lệ tăng trưởng tăng dần.*
...
với $P_{0}$ là dân số ở thời điểm $t_{0}$, và $P$ là dân số ở thời điểm $t$ nếu tỉ lệ tăng trưởng không đổi ở mức $p$. Chuyển vế và lấy logarit hai vế[^3], ta có:
...
!!! info "Ví dụ 3.1"
    ...
    **Phương trình** $\textbf{3.2}$ được dùng để kết luận rằng để tăng từ $7$ lên $8$ tỉ người cần ít hơn $14$ năm với tỉ lệ $1\%$ một năm. Tính toán như thế này: $ln(8/7) / ln 1{,}01 = 13{,}4$. Lưu ý rằng chúng ta không cần phải thêm hàng tỉ ở tử số và mẫu số vì chúng triệt tiêu lẫn nhau.
...
Chúng ta có thể tạo ra một mô hình đơn giản để mô tả sự tiến triển của dân số trong một môi trường có **phản hồi ngược**. Khi một quần thể còn nhỏ và nguồn tài nguyên dồi dào, tỉ lệ sinh tỉ lệ với quần thế đó.
...
Nếu **Ví dụ** $\textbf{3.1}$ chỉ dừng lại ở đó, chúng ta sẽ có tăng trưởng liên tục theo hàm số mũ: càng nhiều nai con có nghĩa là quần thể càng lớn, và cuối cùng khi đạt đến độ tuổi sinh nở lại sản sinh ra nhiều nai con hơn[^6]. Nhưng khi quần thể gia tăng, phản hồi ngược bắt đầu có tác dụng. Chúng ta kí hiệu quần thể là $P$, tỉ lệ thay đổi là $\dot{P}$[^7]. Chúng ta có thể nói tỉ lệ tăng trưởng ($\dot{P}$), là:

$$
\dot{P} = rP \tag{3.3}\label{3.3}
$$

với r là tỉ lệ sinh tương ứng với dân số (ví dụ, bằng $0.04$ nếu $4\%$ dân số sẽ sinh con trong một năm)[^8]. Phương trình này lắp lại một ý tưởng đơn giản: tỉ lệ tăng trưởng của dân số phụ thuộc và tương ứng với dân số *hiện tại*. Nghiệm của *phương trình vi phân* này là một hàm số mũ:
...
[^8]:
    ...
    Theo tỉ lệ tăng trưởng chúng ta đã sử dụng, $p$, như trong **Phương trình** $\textbf{3.1}$, $r = ln(1+p)$. Nên ví dụ, nếu tăng trưởng ở mức $2\%$, $p=0{,}02$ và $r$ bằng $0{,}02$ ($r ≈ p$ với giá trị $p$ rất nhỏ).
