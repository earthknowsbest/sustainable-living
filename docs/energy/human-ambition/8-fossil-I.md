...
Than đã mở ra cánh cửa cho cuộc **Cách mạng Công nghiệp** (*Industrial Revolution*)[^12] vào cuối thế kỷ 18, cho phép vận tải (tàu hỏa), sản xuất cơ giới hóa, xử lí vật liệu trên qui mô lớn và các ứng dụng sưởi ấm. Có thể hơi vòng quanh, nhưng động động cơ hơi nước đầu tiên được sử để bơm nước ra khỏi mỏ than và tăng tốc quá trình khai thác... than. Sự kiện thực tế này càng nhấn mạnh rằng ngay từ buổi đầu, Cách mạng Công nghiệp đã chú trọng vào [khai thác] các nguồn nhiên liệu hoá thạch vốn khơi mào công cuộc này.
...
[^38]:
    ...
    ...không tính oxy; chỉ là nhiên liệu gốc các-bon
