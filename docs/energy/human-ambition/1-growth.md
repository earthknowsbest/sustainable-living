...
Có rất nhiều yếu tốt khác có thể can thiệp vào quá trình giới hạn tăng trưởng ở cả **qui mô dân số** (*population*) lẫn **tài nguyên sử dụng** (*resource use*): **khan hiếm nguồn tài nguyên** (*resource scarcity*), **ô nhiễm** (*pollution*), **tầng nước ngầm cạn kiệt** (*aquifer depletion*), **thiếu nước ngọt** (*water availability*), **biến đổi khí hậu** (*climate change*), **chiến tranh** (*warfare*), **nghề đánh bắt thủy sản sụp đổ** (*fisheries collapse*), diện tích đất trồng trọt thu hẹp (**do sa mạc hóa**, *desertification*), **nạn phá rừng** (*deforestation*), **bệnh tật** (*disease*), v.v. Những yếu tố này đều ngăn cản việc tăng trưởng không ngừng. Bằng cách này hay cách khác, chúng ta cần xem giai đoạn tăng trưởng hiện tại chỉ là một quá trình ngắn hạn: một chớp mắt trong lịch sử nhân loại.
