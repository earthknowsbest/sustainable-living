...
>**Hình 9.12**: Nồng độ CO~2~ tăng nếu thay thế than đá (có cường độ CO~2~ tệ nhất) với khí đốt tự nhiên (có cường độ CO~2~ tốt nhất) và giữ nguyên như vậy đến cuối thế kỉ này. Mức phát thải hàng năm giảm từ 2,6 ppm~v~/năm xuống còn 1,8 ppm~v~/năm do sự thay thế này, và tổng lượng tích luỹ sẽ bằng 268 ppm~v~ ở cuối thế kỉ này (gấp 2,2 lần mức tích luỹ cho đến thời điểm hiện tại). Nhiệt độ theo đó sẽ tăng 2,9°C.
...
Trái đất nhìn chung đang ở **trạng thái cân bằng nhiệt động** (*thermodynamic equilibrium*). Mặt trời truyền năng lượng lên Trái đất với cường độ 240 W/m2, khi tính trung bình trên bề mặt ([Phương trình 9.3](9-climate-I.md#2-co-che-lam-nong)) [9.3](9-climate-I.md#mjx-eqn%3A93). Trước sự gia tăng nồng độ CO2 hiện tại, chúng ta không có cường độ bức xạ bổ sung từ CO~2~ và có nhiệt độ bề mặt trung bình là 288 K (15°C), như trong [Phương trình 9.4](9-climate-I.md#2-co-che-lam-nong). Vì nó ở trạng thái cân bằng nên chúng ta biết rằng bức xạ hồng ngoại từ Trái đất cũng phải có tổng cộng 240 W/m^2 để cân bằng với mặt trời.
...
[^48]:
    ...
    ...là kết quả của việc không còn trong tình trạng cân bằng nhiệt độ nữa

[^49]:

    Ví dụ, H~2~O, CH~4~

Cuối cùng, trạng thái cân bằng được thiết lập lại ở ***ô cuối cùng*** trong **Hình 9.15**, tại đó năng lượng thoát ra và năng lượng đầu vào lại bằng nhau ở mức 240 W/m^2^. Các cơ chế phản hồi về cơ bản đã tăng gấp ba lần sự thay đổi về khả năng hấp thụ GHG: ban đầu tăng 1% cuối cùng lên thành 3%. Nếu không có hiệu ứng này, hệ thống sẽ cân bằng ở 288,6 K (15,6°C)[^50] trong đó trường hợp 393 W/m^2^ rời khỏi mặt đất và 153 W/m^2^ được bức xạ lại từ khí quyển.
...
Bây giờ chúng ta hãy tìm hiểu thêm một chút về quá trình làm nóng không khí, nước, đất và băng trên Trái đất khi năng lượng bức xạ ra không khớp với năng lượng đầu vào[^51]. Chúng ta biết từ [Phần 2](9-climate-I.md#2-co-che-lam-nong): cần có năng lượng để thay đổi nhiệt độ của một vật nào đó. Ví dụ, cần 4.184 J để tăng nhiệt độ của một kilogram (hay một lít) nước lên 1°C, khoảng 1.000 J đối với nhiều chất khác như không khí và đá. Vấn đề liên quan và chưa được đề cập ở đây: cần một lượng năng lượng đáng kể để làm tan băng.
...
Đặt vào trong bối cảnh, lượng tươn đương 334 J đó sẽ làm nóng một gram nước lỏng lên 80°C, trong khi đó bị tiêu hao trong quá trình chuyển pha (từ đóng băng sang lỏng) mà thực tế không làm thay đổi nhiệt độ chút nào[^53].
...
Sử dụng các đặc tính của các thành phần khác nhau trong **Bảng 9.6**, chúng ta có thể xây dựng **Bảng 9.7** để mô tả lượng năng lượng cần thiết để “nạp” các thành phần khác nhau trên trái đất đến nhiệt độ khác nhau[^54]. Lưu ý rằng đại dương cần gấp 1.000 lần nhiệt năng hơn bầu khí quyển để làm nóng lên một mức tương tự.
...
!!! example "Ví dụ 9.4.1" 
    ...
    Tương tự&mdash;nhưng không với yếu tố tăng nhiệt độ nào ở đây&mdash;sẽ cần ~ 49 × 10^21^ J để làm tan 10 m băng trên Trái đâts, và cần 8,8 × 10^24^ J để làm tan tất cả băng.

Với thông tin trên, giờ đây chúng ta có thể ước lượng được phải mất bao lâu để thay đổi nhiệt độ trên qui mô hành tinh khi sự mất cân bằng năng lượng diễn ra do bức xạ cưỡng bức. Ví dụ, nếu sự mất căng bằng là 1 W/m^2^[^55] thì trái đất nhận được thêm 5,1 × 10^14^ J mỗi giây, hay 1,6 × 10^22^ J một năm[^56]. Chúng ta có thể so sánh năng lượng dư thừa hàng năm với số liệu trong **Bảng 9.7** để hiểu sâu sắc về cách các thành phần trái đất sẽ nóng lên hay tan chảy mỗi năm với mỗi 1 W/m^2^ bức xạ cưỡng bức.
...
!!! success ""
    ...
    Nếu sự mất cân bằng bức xạ cưỡng bức lớn ơn hay nhỏ hơn 1 W/m^2^, hiệu ứng sẽ tăng lên hay giảm đi tương ứng. Theo đó, giả sử nhiệt độ tăng lên hơn 1°C thì độ sâu bị đốt nóng sẽ lớn hơn tương ứng. 
...
Điều chúng ta thất được từ các ví dụ trên: đại dương và băng là “phanh” nhiệt rất hiệu quả khi trái đất nóng lên nhanh. Ngay cả khi băng có nhiệt dung riêng rất lớn tính trên kilogram[^59], khối lượng tổng cộng của nó lại nhỏ hơn của đại dương rất nhiều&mdash;hai đặc điểm này cân bằng nhau. Trên thực tế, chúng ta có thể mong đợi rằng những dòng lưu chuyển trong đại dương tập trung nhiệt ở những tầng trên cùng [của đại dương] thay vì phân bổ nhiệt đều khắp các tầng sâu. Vì thế, các tầng trên cùng của đại dương&mdash;điều khiển nhiệt độ không khí&mdash;có tăng thêm 1°C rất lâu trước khi 367 năm trôi qua (**Ví dụ 9.4.3**). Thực vậy, chúng ta đã quan sát thấy việc nóng lên ở qui mô này trong ít hơn một thế kỉ.
...
!!! success ""
    ...
    Mẹo: đừng coi những phần như thế này là thể sách giáo khoa “dạy” cho bạn điều gì đó. Sẽ hiệu quả hơn nhiều nếu đi theo logic, lập luận và tự coi mình là người tham gia tích cực vào vào câu chuyện. Nếu không, trời ơi sao mà chán thế! Giá trị của việc này ở chỗ dùng công cụ để hiểu rõ bản chất của quá trình vật lí.
...
1. cho thấy sự thay đổi trong tỷ lệ hấp thụ GHG dẫn đến sự mất cân bằng bức xạ cưỡng bức như thế nào; 
