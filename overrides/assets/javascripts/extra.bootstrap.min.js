...
function(n) {
    ...
    a.prototype.close = function(t) {
        ...
        o.trigger(t = n.Event("close.bs.alert")),
        t.isDefaultPrevented() || (o.removeClass("in"),
        n.support.transition && o.hasClass("fade") ? o.one("bsTransitionEnd", s).emulateTransitionEnd(a.TRANSITION_DURATION) : s())
    }
    ;
    var t = n.fn.alert;
...
function(c) {
    ...
    function a(s) {
        return this.each(function() {
            ...
            e || t.data("bs.carousel", e = new f(this,i)),
            "number" == typeof s ? e.to(s) : o ? e[o]() : i.interval && e.pause().cycle()
        })
    }
    f.VERSION = "3.3.1",
    ...
    f.prototype.slide = function(t, e) {
        ...
        !h.isDefaultPrevented()) {
            ...
            this.$indicators.length) {
                ...
                var d = c(this.$indicators.children()[this.getItemIndex(o)]);
                d && d.addClass("active")
            }
            ...
            i.one("bsTransitionEnd", function() {
                o.removeClass([t, n].join(" ")).addClass("active"),
                i.removeClass(["active", n].join(" ")),
                r.sliding = !1,
                setTimeout(function() {
                    r.$element.trigger(p)
                }, 0)
            }).emulateTransitionEnd(f.TRANSITION_DURATION)) : (i.removeClass("active"),
            o.addClass("active"),
            this.sliding = !1,
...
function(r) {
    ...
    function n(o) {
        o && 3 === o.which || (r(".dropdown-backdrop").remove(),
        r(l).each(function() {
            var t = r(this)
              , e = h(t)
              , i = {
            ...
            e.hasClass("open") && (e.trigger(o = r.Event("hide.bs.dropdown", i)),
    ...
    o.prototype.toggle = function(t) {
        ...
        if (!e.is(".disabled, :disabled")) {
            ...
            !o) {
                ...
                if (i.trigger(t = r.Event("show.bs.dropdown", s)),
                t.isDefaultPrevented())
                    return;
        ...
        if (/(38|40|27|32)/.test(t.which) && !/input|textarea/i.test(t.target.tagName)) {
            ...
            !e.is(".disabled, :disabled")) {
                ...
                if (!o && 27 != t.which || o && 27 == t.which)
                    return 27 == t.which && i.find(l).trigger("focus"),
                    e.trigger("click");
...
function(n) {
    ...
    a.prototype.hide = function(t) {
        ...
        n.support.transition && this.$element.hasClass("fade") ? this.$element.one("bsTransitionEnd", n.proxy(this.hideModal, this)).emulateTransitionEnd(a.TRANSITION_DURATION) : this.hideModal())
    }
    ,
...
function(v) {
    ...
    m.prototype.init = function(t, e, i) {
        ...
        this.$viewport = this.options.viewport && v(this.options.viewport.selector || this.options.viewport);
        for (var o = this.options.trigger.split(" "), s = o.length; s--; ) {
            ...
            if ("click" == n)
                ...
                this.$element.on(a + "." + this.type, this.options.selector, v.proxy(this.enter, this)),
                this.$element.on(r + "." + this.type, this.options.selector, v.proxy(this.leave, this))
            }
        }
    ...
    m.prototype.applyPlacement = function(t, e) {
        ...
        t.top = t.top + n,
        t.left = t.left + a,
        v.offset.setOffset(i[0], v.extend({
            using: function(t) {
                i.css({
    ...
    m.prototype.hide = function(t) {
        ...
        !o.isDefaultPrevented())
            ...
            v.support.transition && this.$tip.hasClass("fade") ? i.one("bsTransitionEnd", s).emulateTransitionEnd(m.TRANSITION_DURATION) : s(),
    ...
    v.fn.tooltip = function(s) {
        return this.each(function() {
            var t = v(this)
              ...
              , i = "object" == typeof s && s
              , o = i && i.selector;
            (e || "destroy" != s) && (o ? (e || t.data("bs.tooltip", e = {}),
            e[o] || (e[o] = new m(this,i))) : e || t.data("bs.tooltip", e = new m(this,i)),
            "string" == typeof s && e[s]())
        })
    }
    ,
...
function(n) {
    ...
    a.VERSION = "3.3.1",
    a.DEFAULTS = n.extend({}, n.fn.tooltip.Constructor.DEFAULTS, {
        placement: "right",
        trigger: "click",
        content: "",
        template: '<div class="popover" role="tooltip"><div class="arrow"></div><h3 class="popover-title"></h3><div class="popover-content"></div></div>'
    }),
    ((a.prototype = n.extend({}, n.fn.tooltip.Constructor.prototype)).constructor = a).prototype.getDefaults = function() {
        return a.DEFAULTS
    }
    ,
    ...
    n.fn.popover = function(s) {
        return this.each(function() {
            var t = n(this)
              ...
              , i = "object" == typeof s && s
              , o = i && i.selector;
            (e || "destroy" != s) && (o ? (e || t.data("bs.popover", e = {}),
            e[o] || (e[o] = new a(this,i))) : e || t.data("bs.popover", e = new a(this,i)),
            "string" == typeof s && e[s]())
        })
    }
    ,
    n.fn.popover.Constructor = a,
...
function(n) {
    ...
    function s(t, e) {
        ...
        this.$body = n("body"),
        this.$scrollElement = n(t).is("body") ? n(window) : n(t),
        this.options = n.extend({}, s.DEFAULTS, e),
    ...
    s.prototype.refresh = function() {
        var o = "offset"
          , s = 0;
        n.isWindow(this.$scrollElement[0]) || (o = "position",
...
function(r) {
    ...
    a.prototype.show = function() {
        ...
        !t.parent("li").hasClass("active")) {
            ...
            if (o.trigger(s),
            t.trigger(n),
            !n.isDefaultPrevented() && !s.isDefaultPrevented()) {
                var a = r(i);
    ...
    a.prototype.activate = function(t, e, i) {
        ...
        o.length && s ? o.one("bsTransitionEnd", n).emulateTransitionEnd(a.TRANSITION_DURATION) : n(),
        o.removeClass("in")
    }
    ;
    var t = r.fn.tab;
